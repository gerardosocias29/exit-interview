...
export const Privacy = () => {
  return (
    <div className='p-5 bg-primary-indigo text-white'>
      <div className='d-flex justify-content-center gap-5 mb-5'>
        <img src='/login.jpeg' alt='' class='img-thumbnail rounded' width={200} />
        <img src='/bcc.jpeg' alt='' class='img-thumbnail rounded' width={200} />
      </div>

      <h1>Privacy Policy for BCC Exit Interview</h1>

      <p>
        At BCC Exit Interview, accessible from http://bcc.exit-interview.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by BCC Exit Interview and how we use it.
      </p>
      ...
      <p>
        ...
        website with regards to the information that they shared and/or collect in BCC Exit
        Interview. This policy is not applicable to any information collected offline or via
      ...
      <p>
        BCC Exit Interview follows a standard procedure of using log files. These files log visitors
      ...
      <p>
        ...
        Beacons that are used in their respective advertisements and links that appear on BCC Exit
        Interview, which are sent directly to users' browser. They automatically receive your IP
      ...
      <p>
        Note that BCC Exit Interview has no access to or control over these cookies that are used by
      ...
      <p>
        BCC Exit Interview's Privacy Policy does not apply to other advertisers or websites. Thus,
      ...
      <p>
        BCC Exit Interview does not knowingly collect any Personal Identifiable Information from
